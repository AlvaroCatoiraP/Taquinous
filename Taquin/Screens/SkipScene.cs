...
namespace Taquin.Screens
{
        /// <summary>
        /// Represents the scene displayed when time runs out in the game.
        /// </summary>
        internal class SkipScene : TableLayoutPanel
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SkipScene"/> class.
            /// </summary>
            /// <param name="window">The main window of the game.</param>
            public SkipScene(MainScene window)
            {
                this.window = window;
                this.AutoSize = true;
                ...
                {
                    Text = "Vous avez passé un tour, vous perdez une vue.\n Voulez-vous Continuer ?",
