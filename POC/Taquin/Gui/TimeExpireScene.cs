...
namespace Taquin
{
    ...
    internal class TimeExpireScene : TableLayoutPanel
    {
        ...
        public TimeExpireScene(MainScene window)
        {
            ...
            {
                Text = "Time is up. Do you want to retry the level?",
            ...
            else
            {
                ...
                yes_button.Text = "You have no lives left.";
            }
        ...
        private void Button_yes_Click(object sender, EventArgs e)
        {
            ...
            int board_size = this.game.Get_current_round().Get_Board().Get_GridSize();
            this.game.Get_current_level().Add_new_round(new Round(board_size));
